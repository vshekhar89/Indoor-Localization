...
public class GetViewOfMap extends ImageView {
    ...
    private float width;
    private String mDebug = GetViewOfMap.class.getName();
    ...
    protected void onSizeChanged(int w, int h, int old_w, int old_h) {
        ...
        width = (float)w;
        height = (float)h;
        Log.d(mDebug,"value of w: "+ w);
        Log.d(mDebug, "value of h: " + h);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Log.d(mDebug,"value of scale_x: "+ scale_x);
        Log.d(mDebug,"value of scale_y: "+ scale_y);
        x*= scale_x;
        y*= scale_y;
        Log.d(mDebug,"value of x: "+ x);
        Log.d(mDebug,"value of y: "+ y);
